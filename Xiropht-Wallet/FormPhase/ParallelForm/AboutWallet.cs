...
namespace Xiropht_Wallet.FormPhase.ParallelForm
{
    public partial class AboutWallet : Form
    {
        ...
        private void About_Load(object sender, EventArgs e)
        {
            ...
            labelWalletGuiVersion.Text = "GUI Wallet Xiropht v" + Assembly.GetExecutingAssembly().GetName().Version + "b"+Environment.NewLine+ "Copyright © "+DateTime.Now.Year+" Xiropht Developer";
        }
